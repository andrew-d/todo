...
import (
	...
	"github.com/andrew-d/todo/server/conf"
	"github.com/andrew-d/todo/server/datastore"
	"github.com/andrew-d/todo/server/datastore/database"
	"github.com/andrew-d/todo/server/log"
	"github.com/andrew-d/todo/server/middleware"
	"github.com/andrew-d/todo/server/router"
)
